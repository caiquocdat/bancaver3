...
import bum.keo.bancagame.databinding.ActivityPlayBinding;
...
public class PlayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activityPlayBinding.caiDatImg.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if(countDownTimer != null && !isPaused) {
                    countDownTimer.cancel();
    ...
    private void getData() {
        ...
        activityPlayBinding.tv1.setText("Lv"+(value+1));
        activityPlayBinding.tv2.setText("Lv"+(value+2));
    }
                ...
                for (int i = 0; i < activityPlayBinding.brgRel.getChildCount(); i++) {
                    ...
                    if (tag != null && (fishImagesRight.contains((Integer) tag) || fishImagesLeft.contains((Integer) tag))) {
                        ...
                        if (fishRect.contains((int) touchX + 100, (int) touchY + 100)) {
                            ...
                            activityPlayBinding.progressBar.setProgress(point);
                            if (point>1000){
                                Toast.makeText(PlayActivity.this, "Bạn đã chiến thắng level "+(value+1)+" !", Toast.LENGTH_SHORT).show();
                                finish();
